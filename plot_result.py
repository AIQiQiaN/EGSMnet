...
import matplotlib
matplotlib.use('Agg')  # 使用适合保存图像的非交互式后端
import os
import pandas as pd
import numpy as np
...
names = ['yolov8n', 'RLRD-YOLO']

plt.figure(figsize=(12, 9))

plt.subplot(2, 2, 1)
for i in names:
    data = pd.read_csv(f'/root/autodl-tmp/runs/train/{i}/results.csv')
    ...
    plt.plot(data['   metrics/precision(B)'], label=i ,linewidth=2)
plt.xlabel('epoch')
plt.title('precision')
plt.legend()
...
for i in names:
    ...
    plt.plot(data['      metrics/recall(B)'], label=i ,linewidth=2)
plt.xlabel('epoch')
plt.title('recall')
plt.legend()
...
for i in names:
    ...
    plt.plot(data['       metrics/mAP50(B)'], label=i ,linewidth=2)
plt.xlabel('epoch')
plt.title('mAP_0.5')
plt.legend()
...
for i in names:
    ...
    plt.plot(data['    metrics/mAP50-95(B)'], label=i ,linewidth=2)
plt.xlabel('epoch')
...
for i in names:
    ...
    plt.plot(data['         train/box_loss'], label=i ,linewidth=2)
plt.xlabel('epoch')
...
for i in names:
    ...
    plt.plot(data['         train/dfl_loss'], label=i ,linewidth=2)
plt.xlabel('epoch')
...
for i in names:
    ...
    plt.plot(data['         train/cls_loss'], label=i ,linewidth=2)
plt.xlabel('epoch')
...
for i in names:
    ...
    plt.plot(data['           val/box_loss'], label=i ,linewidth=2)
plt.xlabel('epoch')
...
for i in names:
    ...
    plt.plot(data['           val/dfl_loss'], label=i ,linewidth=2)
plt.xlabel('epoch')
...
for i in names:
    ...
    plt.plot(data['           val/cls_loss'], label=i ,linewidth=2)
plt.xlabel('epoch')
...
#  bus: RGB(255, 0, 0)    pedestrian: RGB(0, 165, 255)   truck: RGB(139, 0, 139)     van: (102, 0, 255)     car: (255, 191, 0)

# 'datasets/VisDrone/VisDrone2019-DET-test-dev/images/0000073_05010_d_0000006.jpg',
# 'datasets/VisDrone/VisDrone2019-DET-test-dev/images/9999993_00000_d_0000014.jpg',
# 'datasets/VisDrone/VisDrone2019-DET-test-dev/images/0000365_01000_d_0000225.jpg'