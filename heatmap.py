...
def get_params():
    params = {
        'weight': '/root/autodl-tmp/runs/train/RLRD-YOLO/weights/best.pt',   # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
        # 'device': 'cpu',
        'method': 'HiResCAM',
...
if __name__ == '__main__':
    ...
    model(r'/root/autodl-tmp/VisDrone2019/VisDrone2019-DET-test/images/9999939_00000_d_0000020.jpg', 'result')
    #model(r'/root/autodl-tmp/hit-uav3/images/val', 'result')