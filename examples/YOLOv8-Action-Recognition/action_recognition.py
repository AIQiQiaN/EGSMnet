...
class TorchVisionVideoClassifier:
    ...
    def postprocess(self, outputs: torch.Tensor) -> Tuple[List[str], List[float]]:
        ...
        Returns:
            List[str]: The predicted annotations.
...
class HuggingFaceVideoClassifier:
    def __init__(
        ...
        Args:
            labels (List[str]): List of annotations for zero-shot classification.
    ...
    def postprocess(self, outputs: torch.Tensor) -> Tuple[List[List[str]], List[List[float]]]:
        ...
        Returns:
            List[List[str]]: The predicted top3 annotations.
...
def run(
    ...
    Args:
        ...
        labels (List[str], optional): List of annotations for zero-shot classification. Defaults to predefined list.
    ...
    if video_classifier_model in TorchVisionVideoClassifier.available_model_names():
        ...
        print(
            "'annotations' is not used for TorchVisionVideoClassifier. Ignoring the provided annotations and using Kinetics-400 annotations."
        )
...
def parse_opt():
    ...
    parser.add_argument(
        ...
        help="annotations for zero-shot video classification",
    )
