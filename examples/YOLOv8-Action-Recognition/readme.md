...
# Basic usage
python action_recognition.py --source "https://www.youtube.com/watch?v=dQw4w9WgXcQ" --annotations "dancing" "singing a song"
...
python action_recognition.py --source "https://www.youtube.com/watch?v=dQw4w9WgXcQ" --device 0 --video-classifier-model "microsoft/xclip-base-patch32" --annotations "dancing" "singing a song" --fp16
```
...
```bash
python action_recognition.py --source https://www.youtube.com/watch?v=dQw4w9WgXcQ --annotations "dancing" "singing" "jumping"
```
